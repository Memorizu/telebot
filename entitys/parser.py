...
url_genres = 'https://www.kinopoisk.ru/lists/categories/movies/8/'
url_movies = 'https://www.kinopoisk.ru/lists/movies/?b=top&sort=rating'
...
# r = requests.get(url_genres, headers=headers)
#
...
soup = bs(r.content, 'lxml')
movies = soup.find('div', class_='styles_contentSlot__h_lSN').find_all('span', class_='styles_mainTitle__IFQyZ styles_activeMovieTittle__kJdJj')
